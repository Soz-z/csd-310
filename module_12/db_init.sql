/*
    ...
    Author: Daniel Clark
    Date: 10/3/22
    Description: 12.3 assignment
*/


-- Added drop user later as it was needed to test other students databases
DROP USER IF EXISTS 'whatabook_user'@'localhost';

-- Create user in specifications with instruction, make sure all other users are dropped for the Whatabook database
